...
output=$( java -jar /usr/local/src/benchbase/target/benchbase-postgres/benchbase.jar -b tpch -c "$config_file" -d /usr/local/src/cloudfactory/dump/"tpcc-$1" --execute=true 2>&1 )
epoch=$( date +%s%N )
